...
#define APPNAME "HELLO_WIN - hexists(APP)=true"
#else
#define APPNAME "HELLO_WIN - hexists(APP)=false"

#endif

#if defined(APP) && hexists(APP)

#define APPCONTENT "HELLO_WIN - defined(APP) && hexists(APP)=true"
#else
#define APPCONTENT "HELLO_WIN - defined(APP) && hexists(APP)=false"
